  ...
  public TrainingSessionDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTrainingSession = new EntityInsertionAdapter<TrainingSession>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR IGNORE INTO `trainingSession_table` (`id`,`dateString`,`successScore`,`failScore`,`totalScore`,`resultScore`,`sessionTime`) VALUES (nullif(?, 0),?,?,?,?,?,?)";
      }
      ...
      public void bind(SupportSQLiteStatement stmt, TrainingSession value) {
        ...
        if (value.getSessionTime() == null) {
          ...
          stmt.bindString(7, value.getSessionTime());
        }
      }
    };
      ...
      public List<TrainingSession> call() throws Exception {
        ...
        try {
          ...
          while(_cursor.moveToNext()) {
            ...
            _item = new TrainingSession(_tmpId,_tmpDateString,_tmpSuccessScore,_tmpFailScore,_tmpTotalScore,_tmpResultScore,_tmpSessionTime);
            _result.add(_item);
          }
          return _result;
        } finally {
