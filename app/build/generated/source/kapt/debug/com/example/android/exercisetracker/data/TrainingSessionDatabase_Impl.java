...
public final class TrainingSessionDatabase_Impl extends TrainingSessionDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `trainingSession_table` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `dateString` TEXT NOT NULL, `successScore` TEXT NOT NULL, `failScore` TEXT NOT NULL, `totalScore` TEXT NOT NULL, `resultScore` TEXT NOT NULL, `sessionTime` TEXT NOT NULL)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'b2078cda5a524b3ade0a61599315bbe9')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        final HashMap<String, TableInfo.Column> _columnsTrainingSessionTable = new HashMap<String, TableInfo.Column>(7);
        ...
        if (! _infoTrainingSessionTable.equals(_existingTrainingSessionTable)) {
          return new RoomOpenHelper.ValidationResult(false, "trainingSession_table(com.example.android.exercisetracker.data.TrainingSession).\n"
                  + " Expected:\n" + _infoTrainingSessionTable + "\n"
                  + " Found:\n" + _existingTrainingSessionTable);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "b2078cda5a524b3ade0a61599315bbe9", "e4016337019f1c95846eda5b626113d0");
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "trainingSession_table");
  }
