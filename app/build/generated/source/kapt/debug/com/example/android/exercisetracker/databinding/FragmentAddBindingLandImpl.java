...
public class FragmentAddBindingLandImpl extends FragmentAddBinding implements com.example.android.exercisetracker.generated.callback.OnClickListener.Listener {
    ...
    public FragmentAddBindingLandImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 7, sIncludes, sViewsWithIds));
    }
    private FragmentAddBindingLandImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback3 = new com.example.android.exercisetracker.generated.callback.OnClickListener(this, 3);
        mCallback4 = new com.example.android.exercisetracker.generated.callback.OnClickListener(this, 4);
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.addViewModel == variableId) {
            setAddViewModel((com.example.android.exercisetracker.screens.add.AddViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setAddViewModel(@Nullable com.example.android.exercisetracker.screens.add.AddViewModel AddViewModel) {
    ...
    protected void executeBindings() {
        ...
        com.example.android.exercisetracker.screens.add.AddViewModel addViewModel = mAddViewModel;
        ...
        if ((dirtyFlags & 0x10L) != 0) {
            ...
            this.failButton.setOnClickListener(mCallback3);
            this.resultButton.setOnClickListener(mCallback4);
            this.startButton.setOnClickListener(mCallback1);
            this.successButton.setOnClickListener(mCallback2);
        }
        if ((dirtyFlags & 0x1aL) != 0) {
            // api target 1
